...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<meta property="og:image" content="./img/fbdoge.png">
	...
	<body class="bg">
		...
		<div class="suchlikes">
			...
			<div class="tw-like much-like"><a href="https://twitter.com/share" class="twitter-share-button" data-url="http://dogecycle.com/" data-text="wow such period tracking" data-hashtags="dogecycle, doge"></a></div>
		</div>
		<?php
			if ($login->isUserLoggedIn() == true)
		...
		<div class="ourinfo"> wow <a href="https://github.com/erraticmusings/dogecycle" target="_blank">github</a> such <a href="http://dogeweather.com/" target="_blank">inspired</a></div>
